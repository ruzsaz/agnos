...
function panel_bar2d(init) {
    ...
    this.defaultInit = {group: 0, position: undefined, dimx: 0, dimy: 1, val: 0, multiplier: 1, ratio: false, streched: false, domain: [], domainr: []};
...
panel_bar2d.prototype.drawLegend = function(preparedData, trans) {
    ...
    var legend_new = legend.enter().insert("svg:g", ".bar_group")
            .attr("transform", function(d) {
                return "translate(" + (d.oldX + global.legendOffsetX) + ", " + (that.h - global.legendHeight - global.legendOffsetY) + ")";
            })
            .on("click", function(d) {
    ...
    global.cleverCompress(legendText, that.legendWidth / legendArray.length - 0.5 * global.legendOffsetX, 1, undefined, false, true, that.legendWidth / legendArray.length);
};
